...
from VideoIndexer.account_token_provider import get_arm_access_token, get_account_access_token_async
...
class VideoIndexerClient:
    ...
    def upload_url_async(self, video_name:str, video_url:str, excluded_ai:list[str],
                         wait_for_index:bool,source_language:str='auto',video_description:str='', privacy='private') -> str:
        '''
        ...
        print("****** upload_url_async - URL *******:", url)
        ...
        params = {
            ...
            'privacy': privacy,
            'videoUrl': video_url,
            # set source language to auto / multi detect
    ...
    def file_upload_async(self, media_path:str, video_name:str, excluded_ai:list[str],
        ...
        print("****** file_upload_async - URL *******:", url)
    ...
    #  Addtional methods added
    def get_video_insights_widgets_url_async(self, video_id:str, widget_type:str, allow_edit:bool=False) -> str:
        '''
        Calls the getVideoInsightsWidget API
        (https://api-portal.videoindexer.ai/api-details#api=Operations&operation=Get-Video-Insights-Widget)
        It first generates a new access token for the video scope.
    ...
    #  Addtional methods added to get the all video insights such as Transcription, Names entities, Object detection   
    def get_video_insights(self, video_id:str,re_Translate:bool=False) -> str:
        '''
        Calls the Get Video Index  API
        (https://api.videoindexer.ai/{location}/Accounts/{accountId}/Videos/{videoId}/Index)
        It first generates a new access token for the video scope.
        Prints the VideoInsightsIndex URL, otherwise throws exception.
        ...
        print(f'Getting the captions URL for video {video_id}')
        ...
        response.raise_for_status()
        print ("***print status code here***:", response.status_code)
       

        insights_index_url = response.url
        print(f'Got the insights index URL: {insights_index_url}')
        return response.json()
        #return response.content

    #  Addtional methods added to get  video transription as translate to target language 
    def get_video_transcription_translation(self, video_id:str,language:str='en-GB',re_Translate:bool=False) -> str:
        '''
        Calls the Get Video Index  API
        (https://api.videoindexer.ai/{location}/Accounts/{accountId}/Videos/{videoId}/Index)
        It first generates a new access token for the video scope.
